...
public class AppShellStarter {
    ...
    public void insert(@ShellOption(defaultValue = "default title") String title,
                       @ShellOption(defaultValue = "genre1") String genre,
                       @ShellOption(defaultValue = "author1") String args) {
    ...
    public void deleteById(@ShellOption String id) {
        bookService.deleteBookById(id);
    }

    @ShellMethod(value = "update book", key = {"u", "update"})
    public void updateById(@ShellOption String id,
    ...
    public void updateComment(@ShellOption String id, @ShellOption String comment, @ShellOption String bookId) {
    ...
    public void findAllByBookId(@ShellOption String bookId) {
